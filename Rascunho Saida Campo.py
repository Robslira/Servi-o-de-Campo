...
# Salvar o DataFrame atualizado no arquivo Excel (caso a coluna 'Perfil' tenha sido criada)
df.to_excel(caminho_arquivo, sheet_name="Planilha1", index=False)
print("Tabela Excel atualizada com as alterações.")
